...
from invoices.views import GeneratePdf,PDF,InvoiceEmailView,MakeInvoiceView,IndexView,InvoicesView,InvoiceViewView,InvoiceAddView, InvoiceEditView,InvoiceDeleteView,InvoicePdfView
